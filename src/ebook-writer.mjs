...
const EPUB_FILE = join(import.meta.dirname, '天龙八部.epub');
...
const embeddings = new OpenAIEmbeddings({
  ...
  // 关键：必须指定 encodingFormat 为 'float'，
  // 否则 OpenAI SDK v6 会默认发送 encoding_format='base64'，
  // 而智谱 API 不支持 base64，导致向量全部变成 0
